 ...
 <footer class="main-footer d-none" >
   <!-- To the right -->
   <!-- Default to the left -->
   <strong>Copyright &copy; 2021 </strong> Todos os direitos
   reservados.
 </footer>
 </div>
 <!-- ./wrapper -->
 ...
 <script src="../../plugins/datatables-colreorder/js/colReorder.bootstrap4.min.js"></script>
 ...
 <!-- FontAwesome 5 -->
 <script src="../../plugins/fontawesome-free/js/fontawesome.min.js"></script>
 <!-- Summernote -->
