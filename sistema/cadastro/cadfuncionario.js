$(document).ready(function () {
        ...
        table = $("#datatable").DataTable({
            ...
            columns: [
                { title: "ID", data: "idfuncionario", width: "5%" },
                { title: "Nome", data: "nome", width: "10%" },
                { title: "DtNascimento", data: "dtnascimento", width: "10%" },
                { title: "Salário", data: "salario", width: "10%" },
                { title: "Usuário", data: "usuario", width: "10%" },
                { title: "Senha", data: "senha", width: "10%" },
                ...
                <div class="dropdown dropleft">
                    ...
                    <div class="dropdown-menu cursor" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" onclick="clique('${rowData.idfuncionario}')">
                            <i class="fas fa-edit text-success"></i> Editar 
                        </a>
                        <a class="dropdown-item"  onclick="excluir('${rowData.idfuncionario}')" > 
